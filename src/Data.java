...
public class Data {
    // Et integer array der indenholder 1000 tilfældig tal.
    ...
    // Et integer array der indenholder 100 tilfældige tal .
    private int[] randomNumbers10= {5, 0, 1, 9, 4, 8, 6, 6, 2, 5};

    //Et array af Strings der indenholder tilfældige pige navne:
    ...
    // Et array af Strings der indenholder tilfældige drenge navne:
    ...
    // Main metoden der kalder en randomNumbers metode med parameterne 10, 10.
    public static void main(String[] args) {
        randomNumbers(10, 10);
    }
    //en metoder der er void hvilket vil sige den ikke retunere noget. metoden tager imod 2 formale argumenter.
    //en integer n og en integer max. og retunere så n random tal inden for max værdi.
    private static void randomNumbers(int n, int max) {
    // en sout der printer et tuborg parentes.
        System.out.print("{");
...
// Getters.
    ...
    public int[] getRandomNumbers1000(){return randomNumbers1000;}
